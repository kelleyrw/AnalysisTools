...
class smsPlotABS(object):
    ...
    def setStyle(self):
        ...
        self.c.SetTickx(1)
        self.c.SetTicky(1)
        self.c.SetGridx(False);
        self.c.SetGridy(False);
    ...
    def DrawText(self):
        ...
        # CMS LABEL
        textCMS = rt.TLatex(0.25,0.98,"CMS%s, L = %s fb^{-1}, #sqrt{s} = %s TeV" %(self.preliminary, self.lumi, self.energy))
        textCMS.SetNDC()
